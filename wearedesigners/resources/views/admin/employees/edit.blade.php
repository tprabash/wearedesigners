...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="profile_photo">{{ trans('cruds.employee.fields.profile_photo') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.employee.fields.profile_photo_helper') }}</span>
            </div>
            <div class="form-group">
...
@if(isset($employee) && $employee->profile_photo)
      var file = {!! json_encode($employee->profile_photo) !!}
